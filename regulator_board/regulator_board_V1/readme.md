...
Brief
- Power regulator board for converting input voltage to stable output rails used by other system components.

Key features
- Voltage regulation and filtering
- Output power distribution connectors
- KiCad schematic and layout included
